    ...
    Ext.onReady(function() {
        ...
        OpenLayers.DOTS_PER_INCH = 25.4 / 0.28;
            ...
            var options = {
                controls: [],
                maxExtent: bounds,
                maxResolution: 229.240062109375,
            ...
            tiled = new OpenLayers.Layer.WMS(
                "housingWS:housingAssessmentLayer - Tiled", "/housing/geoserver/housingWS/wms",
                {
                    LAYERS: 'housingWS:housingAssessmentLayer',
                    STYLES: '',
                    format: format,
                    tiled: true,
            ...
            untiled = new OpenLayers.Layer.WMS(
                "housingWS:housingAssessmentLayer - Untiled", "/housing/geoserver/housingWS/wms",
                {
                    LAYERS: 'housingWS:housingAssessmentLayer',
                    STYLES: '',
                    format: format
        ...
        new GeoExt.MapPanel({
            ...
            width: 800,
            map: map,
            title: 'Hosuing Assessment Result Map',
            region: 'center',
