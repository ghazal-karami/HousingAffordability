package au.org.housing.proxy.servlet;
 ...
 * 
 * This convenience extension to ProxyServlet configures the servlet as a ProxyServletWithAuth proxy. The servlet is configured with init parameters:
 * <ul>
...
public class ProxyServletWithAuth extends ProxyServlet
{
    ...
    public ProxyServletWithAuth(String prefix, String schema, String host, int port, String path)
    {
        try
        {
            if (prefix != null)
